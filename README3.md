...
| **DevOps для ML** | Docker, CI/CD для ML-пайплайнов, MLflow |
| **UX/UI для AI** | Flutter/Dart, Figma, мобильная разработка |

## 🚀 КЛЮЧЕВЫЕ ПРОЕКТЫ

### 🔹 Мультиагентная система для операторов контакт-центра | True Tech Hack
**Роль:** Ведущий ML инженер, архитектор решения
...
- **2023:** Сертификация DeepLearning.AI — Large Language Models: Application through Production
- **2022:** Сертификация в области компьютерного зрения и обработки данных

## 💼 ПРОФЕССИОНАЛЬНЫЕ ЦЕЛИ

Целенаправленно развиваюсь в направлении лидерства в области AI-систем. Стремлюсь применять передовые подходы к разработке искусственного интеллекта для создания продуктов, приносящих реальную ценность бизнесу и обществу. Активно изучаю новейшие архитектуры моделей и подходы к их внедрению, чтобы делать AI доступным, полезным и безопасным.
