...
**Технологический стек:** Python, LlamaIndex, ChromaDB, Llama Guard
...
**Технологический стек:** PyTorch, HuggingFace Transformers, Keras, KerasTuner

### 🔹 Оптимизация YOLO для распознавания дорожных знаков в сложных условиях

- Улучшил надежность распознавания дорожных знаков с использованием YOLOv11s в условиях низкой освещенности
...
**Технологический стек:** YOLO, Python, OpenCV, PyTorch
